-- =============================================================
-- Quartz Scheduler JDBC Tables — Official PostgreSQL Schema
-- Source: Quartz 2.3.x / quartz-2.3.x-sql/tables_postgres.sql
--
-- Managed by Flyway — spring.quartz.jdbc.initialize-schema=never
-- so Quartz never attempts to auto-create these.
-- =============================================================
...
-- Indexes for performance — match the official Quartz distribution
